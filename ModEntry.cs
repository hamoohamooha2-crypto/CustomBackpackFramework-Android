...
namespace CustomBackpack
{
    public partial class ModEntry : Mod
    {
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            harmony.Patch(
                original: AccessTools.Method(typeof(ShopMenu), nameof(ShopMenu.performHoverAction), new Type[] { typeof(int), typeof(int) }),
                prefix: new HarmonyMethod(typeof(ObjectPatches), nameof(ObjectPatches.ShopMenu_performHoverAction_Prefix))
            );

            harmony.Patch(
                original: AccessTools.Method(typeof(ShopMenu), nameof(ShopMenu.receiveScrollWheelAction), new Type[] { typeof(int) }),
            ...
            harmony.Patch(
                original: AccessTools.Method(typeof(ItemGrabMenu), "customSnapBehavior", new Type[] { typeof(int), typeof(int), typeof(int) }),
            ...
            harmony.Patch(
                original: AccessTools.Method(typeof(SeedShop), nameof(SeedShop.draw), new Type[] { typeof(SpriteBatch) }),
            ...
            harmony.Patch(
                original: AccessTools.Method(typeof(SpecialItem), nameof(SpecialItem.getTemporarySpriteForHoldingUp), new Type[] { typeof(Vector2) }),
                prefix: new HarmonyMethod(typeof(ObjectPatches), nameof(ObjectPatches.SpecialItem_getTemporarySpriteForHoldingUp_Prefix))
            );

            harmony.Patch(
                original: AccessTools.Method(typeof(Farmer), nameof(Farmer.shiftToolbar), new Type[] { typeof(bool) }),
